<template>
    <b-col cols="12" class="page-paddings ">
        ...
        <b-modal size="lg" id="team-modal" hide-header hide-footer @hidden="closeModal">
            <team-slider-component :slides="displayed" :active="slide" :type="'team'"/>
        </b-modal>
    </b-col>
</template>
    ...
    export default {
        ...
        methods: {
            stepClick (id) {
                if (id === 'team_3') {
                    gtag('event', 'click', {
                        'event_category': 'Stephan click',
                        'event_label': 'Stephan click'
                    });
        ...
        computed: {
            displayed () {
                return this.paginatePages(this.teams)
            }
        }
    }
</script>
